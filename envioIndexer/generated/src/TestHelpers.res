...
module ERC20 = {
  module Approval = {
    @genType
    let processEvent: EventFunctions.eventProcessor<Types.ERC20.Approval.event> = EventFunctions.makeEventProcessor(
      ~register=(Types.ERC20.Approval.register :> unit => Internal.eventConfig),
    )
...
->(Utils.magic: Types.ERC20.Approval.eventArgs => Internal.eventParams)

      EventFunctions.makeEventMocker(
        ~params,
        ~mockEventData,
        ~register=(Types.ERC20.Approval.register :> unit => Internal.eventConfig),
      )->(Utils.magic: Internal.event => Types.ERC20.Approval.event)
    }
  }
