...
type loaderContext = {
  ...
  isPreload: bool,
  @as("Approval") approval: entityLoaderContext<Entities.Approval.t, Entities.Approval.indexedFieldOperations>,
}
...
type handlerContext = {
  log: Envio.logger,
  effect: 'input 'output. (Envio.effect<'input, 'output>, 'input) => promise<'output>,
  @as("Approval") approval: entityHandlerContext<Entities.Approval.t>,
}

//Re-exporting types for backwards compatability
@genType.as("Approval")
type approval = Entities.Approval.t
...
module ERC20 = {
let abi = Ethers.makeAbi((%raw(`[{"type":"event","name":"Approval","inputs":[{"name":"owner","type":"address","indexed":true},{"name":"spender","type":"address","indexed":true},{"name":"value","type":"uint256","indexed":false}],"anonymous":false}]`): Js.Json.t))
let eventSignatures = ["Approval(address indexed owner, address indexed spender, uint256 value)"]
