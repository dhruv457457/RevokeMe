...
const SmartAccountPlaceholder = () => (
  <div className="flex flex-col items-center justify-center h-full text-center p-8">
    ...
    <p className="text-sm text-gray-500 mt-1">
      Connect your wallet and set it up to see approvals.
    </p>
  </div>
);
  ...
  <div className="flex flex-col items-center justify-center h-full text-center p-8">
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M21 12.793V9.75a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06.44h-2.122a1.5 1.5 0 01-1.061-.44H4.5A2.25 2.25 0 002.25 9.75v3.043m18.75 0A2.25 2.25 0 0118.75 15h-1.5a2.25 2.25 0 01-2.25-2.25v-1.5a2.25 2.25 0 012.25-2.25h1.5A2.25 2.25 0 0121 12.793z"
      />
    </svg>
    <h4 className="font-semibold text-gray-300">Wallet Not Connected</h4>
    <p className="text-sm text-gray-500 mt-1">
      Connect your wallet to view your main account's approvals.
    </p>
  </div>
);
...
const Home: React.FC = () => {
  ...
  return (
    <div className="w-full text-white min-h-screen px-10 md:px-0">
      <HeroSection />
