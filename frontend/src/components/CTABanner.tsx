  ...
  return (
    <section className="relative py-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto bg-[#0C0C0E] border border-[#333336] rounded-3xl p-8 md:p-12 text-center ">
        ...
        <Link
          to="/revoke-erc20"
          className="inline-flex items-center justify-center px-8 py-3 bg-[#7f48de] hover:bg-[#7437DC] cursor-pointer text-white font-semibold rounded-lg transition-colors text-lg"
        >
          Start Revoking Now
          <svg
